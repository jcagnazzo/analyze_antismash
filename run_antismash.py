...
# Running each SID in SID_list through antismash using SID.name as the output folder name and
# SID.genome_file as the input file
for SID in SID_list:
	run_antismash(SID.genome_file, SID.name)		
